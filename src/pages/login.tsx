    ...
    return (
      <>
        <div className=" bg-white w-1/2 mx-auto my-5 rounded-lg shadow-lg p-16">
            ...
            <form onSubmit={(e) => props.login(e)} className="flex flex-col gap-3">
              <label htmlFor="username" className="text-[#595959] font-bold">Username</label>
                <input type="text" id="username" className="border-2 border-[#595959] p-3 rounded-lg" name="username" onChange={props.handle} />
              <label htmlFor="password" className="text-[#595959] font-bold">Password</label>
                <input type="password" id="password" name="password" className="border-2 border-[#595959] p-3 rounded-lg" onChange={props.handle} />
              <button type="submit" className="bg-[#5E5400] text-white font-bold mt-6 py-3 rounded-lg">SUBMIT</button>
            </form>
