    ...
    return (
        <>
          ...
          <div className="w-full h-screen mx-auto bg-white">
            <h1 className="font-extrabold text-5xl text-[#5E5400] text-center pt-10 mb-10">LIST PARTAI</h1>
            <div className="px-28">
            <a href="/dashboard/add-partai" className="button bg-[#5E5A00] text-white p-3 rounded-lg font-bold">Add Partai</a>
              <table className="w-full mt-5 border-[#828282] ">
                <thead className="text-left bg-[#cecece]">
                  <tr>
                    ...
                    <th className="border border-[#828282] py-2 pl-2">Logo</th>
                    <th className="border border-[#828282] py-2 pl-2">Ketua Umum</th>
                ...
                <tbody className="bg-white">
                  <tr>
                    ...
                    <td className="border border-[#828282] p-2">Kerajaan Wano</td>
                  </tr>
                </tbody>
              </table>
            </div>
